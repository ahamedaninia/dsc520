...
summary(earn_lm)
```
If I were to update this model, I would remove all races and height, as their p-values are very high in comparison to the rest.

```{r}
predicted_df <- data.frame(
  earn = predict(earn_lm, data=heights_df),
